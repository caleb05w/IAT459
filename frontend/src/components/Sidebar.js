...
import { LuClock, LuBookmark, LuLayoutGrid, LuChevronDown, LuPlus, LuSearch } from "react-icons/lu";
...
export default function Sidebar({ activeNav, setActiveNav, activeTeam, setActiveTeam }) {
    ...
    return (
        <aside className="w-60 h-screen bg-white flex flex-col border-r border-gray-100 shrink-0">
            ...
            <div className="px-3 pt-4 pb-3 border-b border-gray-100">
                <button className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-gray-600 bg-gray-50 hover:bg-gray-100 transition-colors">
            ...
            <div className="px-3 py-3">
                <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2">
                    ...
                    <kbd className="text-gray-400 text-xs border border-gray-200 rounded px-1 py-0.5 font-mono">⌘K</kbd>
                </div>
            </div>
            ...
            <div className="px-3 pb-2">
                ...
                >
                    ...
                    <LuChevronDown className={`w-4 h-4 text-gray-500 transition-transform duration-200 ${teamOpen ? "rotate-180" : ""}`} />
                </button>
